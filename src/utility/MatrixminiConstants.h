...
#ifndef MatrixminiConstants_h
#define MatrixminiConstants_h
...
static const int MINI_BTN_REPORT =         0x0B; //report digitalRead of Matrixmini Buttons
/*
// pin modes
