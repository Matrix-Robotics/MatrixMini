...
void setup() {
  ...
  // Ex: sigmap = 3, means allowed signatures are: 1, 2, 3.
...
void loop() {
  ...
  // Then the largest blue block's X is getblock(1, 1), largest red block's X is getblock(2, 1),
  // The second largest blue block's X is getblock(1, 2), second largest red block's X is getblock(2, 2).
  // Note: get block should be use before other functions.
